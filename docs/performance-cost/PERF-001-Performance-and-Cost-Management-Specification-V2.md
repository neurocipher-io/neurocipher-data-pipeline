...
Applies to ingestion APIs, embedding and normalization services, vector index, compliance module scanning workers, and orchestration runtimes deployed on AWS Lambda, ECS Fargate, and Step Functions.
