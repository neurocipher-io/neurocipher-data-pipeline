...
- The canonical Retention & SLO matrix in OBS-001 §5 defines these targets and the associated SLIs (ingest availability 99.9%, ingest latency p95 ≤ 300 ms, vector latency p95 ≤ 200 ms, pipeline freshness ≥ 99 % within 5 minutes, security action latency p95 ≤ 90 s). Use those values as the source of truth when gating merges or evaluating alert thresholds.
